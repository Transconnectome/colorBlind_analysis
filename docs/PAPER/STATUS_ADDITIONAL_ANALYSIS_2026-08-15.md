...
| CVD hV4 보간이 HC 보다 유의하게 낮음 | **유지 안 됨** |
| 개인마다 다른 ROI 에 왜곡이 편재 | **유지 안 됨** (deutan V2 방향 역전) |
| 필터 구성·역산 (수학) | 불변 |
...
| **미분 성분** (ROI 내 SD) | **0.06–0.16 복셀 = 0.12–0.32 mm** | **직접적인 pattern-distortion term.** 복셀 크기의 약 1/10 |
