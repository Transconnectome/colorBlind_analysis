#!/usr/bin/env python3
"""
Phase 2A: fMRI 패턴 추출 (baseline81_deob_determin)

Robustness validation용: Phase 1과 동일한 voxel selection으로 패턴 추출
...
DERIVATIVES_DIR = BASE_DIR / "derivatives/BH2009_deoblique_v2/baseline81_deob_determin"
OUTPUT_DIR = BASE_DIR / "results/group_level/phase2a_data_baseline81/patterns"
...
def create_metadata():
    """메타데이터 생성"""
    metadata = {
        "description": "fMRI patterns for Phase 2A Robustness Validation (baseline81)",
        "created_date": "2025-12-19",
        "source": "derivatives/BH2009_deoblique_v2/baseline81_deob_determin",
        "preprocessing": "baseline81_deob_determin (deoblique, deterministic HRF, 81% voxels)",
        "purpose": "Cross-validation with Phase 1 original voxel selection",
        "subjects": {
            "HC": HC_SUBJECTS,
            "CVD": CVD_SUBJECTS
        },
        ...
        "voxel_selection": "selected_voxels_mask.npy from Phase 1 (81% highest variance)",
...
def main():
    """메인 실행"""
    print("=" * 70)
    print("Phase 2A: Extracting fMRI Patterns (baseline81_deob_determin)")
    print("=" * 70)
    ...
    print("\nNext steps:")
    print("1. Download patterns from server")
    print("2. Run: python scripts/phase2a_train_single.py (with baseline81 paths)")
    print("3. Run: python scripts/validate_filters.py")
    print("4. Compare with baseline32 results")
