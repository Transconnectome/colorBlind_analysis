% Supplementary S3 — Identifiability checks
% 2026-06-05
...
\section*{Supplementary S3: Identifiability checks}
...
per candidate) with GT-consistent JND: behavioral thresholds were
...
JND (no synthetic behavioral signal; PCA-basis).
...
For sub-09, the sign of $\hat\beta_c$ (mechanism class) was confirmed
