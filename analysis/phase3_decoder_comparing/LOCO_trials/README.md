...
Phase 4 Procrustes Filter (★ MAIN PATH) ← notion.md 전략
  ...
  +- Connects to: phase5_filter_optimization/
```
...
### Phase 4: Procrustes Filter Design → phase5_filter_optimization/
...
- See: `analysis/phase5_filter_optimization/pre_validation/notion.md`
...
### Phase 4 (Stimulus-Space Filter) — see phase5_filter_optimization/ README
