...
> 같은 유전형(deuteranopia) 내에서도 반대되는 신경 표현형 확인 → **개인화된 필터 설계 필수**. Procrustes 정렬 후 공통 디코더 공유 가능 (36-42° vs chance 84-96°)
...
| **Sub-09** | Deutan | 1.21 (+21%) | +0.32 | 0.118 | 0.115 (V1) |
| **Sub-10** | Protan | 0.89 (-11%) | -0.05 | 0.310 | 0.117 (V2) |

> 💡 **핵심 발견**: Sub-08 vs Sub-09는 **동일 유전형** (deuteranopia)이지만 **반대 신경 표현형**:
> - Sub-08: 낮은 magnitude, 음성 baseline, 높은 구조적 왜곡
> - Sub-09: 높은 magnitude, 양성 baseline, 낮은 구조적 왜곡
>
> → 범용 CVD 필터는 반대 방향 왜곡 때문에 실패. **개인화 필수**
