...
echo "=================================================================="
echo "Full Dataset P3 Pipeline C010 - Local Test"
echo "=================================================================="
...
python run_full_dataset_C010.py \
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "  /scratch/connectome/haba6030/colorBlind/derivatives/full_dataset_C010/sub-${TEST_SUBJECT}/${TEST_ROI}/"
    echo ""
    echo "Check results:"
    echo "  cat /scratch/connectome/haba6030/colorBlind/derivatives/full_dataset_C010/sub-${TEST_SUBJECT}/${TEST_ROI}/metrics.json"
    echo ""
