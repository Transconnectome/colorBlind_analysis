...
- When best setting for preprocessing, ROI, feature selection, model setting is made. Do 2nd-level analysis and find out
  ...
  (4) Whether (1) ~ (3) are different between CVD(08 ~ 10) and HC(01~07)
...
3. In Cross-ROI and Cross-Subject Patterns, 
  ...
  - Subject Difference: Compare within HC (sub 01, 02, 05, 06, 07) and within CVD(sub 03, 04) and between those groups. 
...
- Objective: Figure out the best feature selection method. 
    - Best 1: Best classification & reconstruction result (especially for HC group)
    - Best 2: Shows significant impairment in CVD group compared to HC
...
- Consider prediction performance on HC individuals.
- Consider performance differences between HC and CVD mappings.
