...
Usage:
    python fir_reconstruction_zScore.py --roi V2 --use-pca --n-components 6
...
Apply Changes?:
    ...
    [O] CHANGE 3: Accurate Lab→RGB color conversion for figures
    [O] CHANGE 4: Set anticlockwise hue direction (IMPLEMENTED)
"""
