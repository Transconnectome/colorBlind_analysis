...
$\theta_{\mathrm{base}}(c)$: family-conditioned baseline hue. 구현 상 $\theta_{\mathrm{base}} = $ `machado_shifted_hue(0, family)`. CIELab nominal 각도 (0°, 45°, ...) 가 아닌 family 별 reference (C_baseline 버그 방지, MEMORY 2026-04-07).
