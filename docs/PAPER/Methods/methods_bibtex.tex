% Methods Section (BibTeX version)
% To be included in main document via \input{methods_bibtex}
...
\subsection*{Behavioral-neural concordance (TBA)}
...
We modeled CVD color distortion as a cone-specific spectral shift ($\Delta\lambda$ in nm) applied to the stimulus hue angles \cite{brettel1997}.
