...
Output:  analysis/phase5_filter_optimization/results/diagnostics/decoder_loco/decoder_loco_long.csv
...
OUT_DIR = ROOT / 'analysis' / 'phase5_filter_optimization' / 'results' / 'diagnostics/decoder_loco'
