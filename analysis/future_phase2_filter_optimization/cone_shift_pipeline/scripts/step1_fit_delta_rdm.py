#!/usr/bin/env python3
"""
step1_fit_delta_rdm.py — ΔRDM loss fitting (V1+V2 combined).
...
Key design:
  ...
  - 2-stage grid: coarse (2° step) → refine (0.5° step around best)
  - Exact 8! permutation test (40,320 perms) for combined loss
  - Two p-values: (1) label_perm_p, (2) baseline_improvement_p (vs δ=0)
...
Usage:
    conda activate srm
    python scripts/step1_fit_delta_rdm.py \
