...
DATASET_CONFIGS = {
    'afni_deoblique_v3': {
        'fmriprep': '/storage/connectome/haba6030/fmriprep_out_afni_deoblique',
        'events': '/storage/connectome/haba6030/colorBlind_data_afni_deoblique',
        'description': 'v3: AFNI 3dWarp deoblique + fieldmap + BBR [NEW STANDARD]'
    },
    'deoblique_v2': {
    ...
    'deoblique': {
        'fmriprep': '/storage/connectome/haba6030/fmriprep_out_deoblique',
        'events': '/storage/connectome/haba6030/colorBlind_data_deoblique',
        'description': 'v1: fieldmap NOT applied (DEPRECATED)'
    },
    'original': {
...
for run in range(1, N_RUNS + 1):
    ...
    if HIGHPASS_HZ is not None and MOTION_TYPE != 'cosine':
    ...
    elif HIGHPASS_HZ is not None and MOTION_TYPE == 'cosine':
