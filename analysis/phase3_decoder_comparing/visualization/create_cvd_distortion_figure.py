...
# FDR results path
FDR_RESULTS_PATH = BASE_DIR / 'analysis/future_phase3_filter_optimization/pre_validation/results/fdr_corrected/filter_pre_validation_fdr_corrected.json'
...
def create_cvd_distortion_figure(roi='V2', output_path=None):
    ...
    if output_path is None:
        output_dir = BASE_DIR / 'analysis/future_phase3_filter_optimization/figures'
