...
\begin{table}[ht]
  ...
  The 2-component model is listed at its adopted fit, selected by held-out composite test-loss ($\overline{L}_{\rm test}$, lower is better) under the $L_\text{fit}$ criterion (main text, Section~\ref{sec:results:twocomp}).
