#!/bin/bash
# Helper script to run RDM reliability analysis
...
echo "Submitting RDM reliability analysis job..."
echo ""

# Submit job with timestamp
sbatch /scratch/connectome/haba6030/colorBlind/analysis/validation/scripts/03_rdm_reliability.sbatch $LATEST_TIMESTAMP
