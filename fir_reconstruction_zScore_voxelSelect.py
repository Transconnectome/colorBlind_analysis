...
if SUBJECT_ID == 'P01':
    output_dir = Path(f"derivatives/{timestamp}/pilot/{DERIVATIVE_PREFIX}/voxelSelect/{ROI_NAME}")
else:
    output_dir = Path(f"derivatives/{timestamp}/{DERIVATIVE_PREFIX}/voxelSelect/{ROI_NAME}")
