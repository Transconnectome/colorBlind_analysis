...
\begin{figure}[htbp]
  ...
  Asterisks are omitted; region-wise tests for both preprocessing pipelines are given in Supplementary~\cref{app:uncorrected}.
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Hue interpolation and representational geometry under each filter in the second
    session.} Rows: the deutan participant (A--C) and the protan participant (D--F). Columns: interpolation and
