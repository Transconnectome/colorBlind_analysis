...
\begin{table}[ht]
  ...
  \begin{tabular}{llcc}
    ...
    Deutan & R+C & $g \to 3.0$ ($\langle 100\%\rangle$ saturated) & rejected (Gate 2) \\
    Protan & R+C & $g = 2.95$ ($\langle 41\%\rangle$ saturated) & $\overline{L}_{\rm test} = -0.86$ \\ \bottomrule
  \end{tabular}
\end{table}
