...
def enumerate_combos_sub08():
    # v4: single-atom combos now enumerated (γ-only, RDM-only, LOCO-only).
    # Empty options added; "not all empty" filter ensures at least 1 atom.
...
def main():
    ...
    out_file = OUT_DIR / f"s10b_v4_single_atom_results{suffix}.json"
