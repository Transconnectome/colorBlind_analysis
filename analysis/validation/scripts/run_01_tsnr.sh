#!/bin/bash
# Helper script to find baseline timestamp and run tSNR validation
...
echo "Submitting tSNR validation job..."
echo ""

# Submit job with timestamp
sbatch /scratch/connectome/haba6030/colorBlind/analysis/validation/scripts/01_tsnr.sbatch $LATEST_TIMESTAMP
