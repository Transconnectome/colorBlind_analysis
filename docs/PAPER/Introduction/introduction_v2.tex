...
Per-subject estimates are validated against an HC leave-one-out distribution under the same loss (Supplementary~\ref{app:hc_perm}); case-level distinctness rests on joint anchors --- HC parameter-norm bracket, directional consistency with cone-physiology, and (pending) Phase-3 behavioral validation.
