...
---------------------
Complete FIR-based color reconstruction pipeline

Combines:
- Per-voxel FIR (better than canonical HRF)
...
output_dir = Path(f"derivatives/sub-{cfg.SUB_ID}/fir_reconstruction/{ROI_NAME}")
...
print("="*70)
print("FIR-based Color Reconstruction Pipeline")
print("="*70)
...
print("="*70)
print("FIR Reconstruction Complete")
print("="*70)
print()
print(f"ROI: {ROI_NAME}")
