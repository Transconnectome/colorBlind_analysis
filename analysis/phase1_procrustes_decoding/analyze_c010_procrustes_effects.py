#!/usr/bin/env python3
"""
Analyze Procrustes Effects for C010 Full Dataset - Validation Analysis
...
Outputs:
  ...
  4. c010_procrustes_analysis.json (Statistics)
...
OUTPUT_DIR = BASE_DIR / "validation_analysis"
...
def compute_summary_statistics(df, output_dir):
    ...
    # Save
    output_file = output_dir / 'c010_procrustes_analysis.json'
    ...
    df_output = output_dir / 'c010_procrustes_detailed.csv'
    df.to_csv(df_output)
...
def main():
    ...
    print("="*80)
    print("C010 Full Dataset Procrustes Effect Analysis")
    print("="*80)
    ...
    print(f"  - {OUTPUT_DIR}/c010_procrustes_analysis.json")
    print(f"  - {OUTPUT_DIR}/c010_procrustes_detailed.csv")
    print("="*80)
